...
```{r}
plot(x = concentrations_nM, y = cell_growth_rates_ACH_000393, col = "blue");abline(lm(regression_model_393), col = "blue")
points(x = concentrations_nM, y = cell_growth_rates_ACH_000471, col = "orange");abline(lm(regression_model_471), col = "orange")
points(x = concentrations_nM, y = cell_growth_rates_ACH_000476, col = "green");abline(lm(regression_model_476), col = "green")
