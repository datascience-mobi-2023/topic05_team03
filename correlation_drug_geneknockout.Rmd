...
same_targets = which(Liver_cancer_target_genes%in%names_correlations_above_threshold_geneknockout)
length(same_targets)
same_targets
names_liver_cancer_target_genes_highcor = Liver_cancer_target_genes[same_targets]
