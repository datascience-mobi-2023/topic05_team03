...
```{r}
#CCCCCCCCCCCCCCCClets find some biomarkers, that are linked with drug sensitivity of CCLs 
...
```{r}
#ARE THERE ANY DRUG/GENE PAIRS THAT BOTH HAVE HIGH CORREALTIONS WITH A BIOMARKER?
