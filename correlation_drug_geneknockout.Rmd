...
high_cor_genknockout_exp = correlation_highcor(prism.achilles, highvar(prism.exp, 0.9))
```

```{r}
#FINDING CORRELATIONS B
high_cor_genknockout_cnv = correlation_highcor(prism.achilles, highvar(prism.exp, 0.9))
```
