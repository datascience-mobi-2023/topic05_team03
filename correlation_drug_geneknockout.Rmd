...
#fpr morgen : herausfinden, wie ich die drug gene pairs in eine ncol = 2 matrix bekomme
```
...
#find the drug/gene pairs 
Ä = 0.15 #threshold
df_drug_gene_pairs = data.frame(matrix(ncol = 0, nrow = 2))  
rownames(df_drug_gene_pairs) <- c("drug", "gene_knockout")
